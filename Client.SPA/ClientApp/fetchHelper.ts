...
export default class fetchHelper {
    ...
    public static API_ACCESS_TOKEN; // this needs to be set in main-vm
    ...
    */
    ...
    private static async RefreshToken() {
        ...
        try {
            ...
            var user: UserDto = await fetchHelper.getResponseAsync(options, SpaService.Url_RenewTokensAsync(), true);
        }
        catch (e) {
